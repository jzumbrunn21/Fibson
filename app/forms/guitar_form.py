...
class GuitarForm(FlaskForm):
    ...
    year = IntegerField('year', validators=[DataRequired(), NumberRange(min=1900, max=2024, message='Year must be between 1900 and 2024')])
    price = IntegerField('price', validators=[DataRequired(), NumberRange(min=1, max=1_000_000, message='Guitar Price must be between $1 and $1,000,000')])
